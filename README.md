...
5. **Press Ctrl+Shift+F7 or Ctrl+Shift+F9** to suspend/resume all hotkeys above (useful if F8 etc. are interfering with another app) — these two keep working even while suspended
